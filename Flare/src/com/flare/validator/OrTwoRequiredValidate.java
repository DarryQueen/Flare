...
public class OrTwoRequiredValidate extends AbstractValidate {
	...
	public boolean isValid(String value) {
		...
		field1Validator.addValidator(new NotEmptyValidator("Field is empty."));
		
		Validate field2Validator = new Validate(_field2);
		field2Validator.addValidator(new NotEmptyValidator("Field is empty."));
